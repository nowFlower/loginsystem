...
let d1 = new DataSet("1. 개발환경구축")//메인 타이틀 //메뉴번호
...
// menu3 =============================================================
let d3 = new DataSet("3. 서버프로그램구현")//메인타이틀
d3.set_content("3. 서버프로그램 구현")
...
d3.set_content("3.4 회원 리스트 출력 구현")
